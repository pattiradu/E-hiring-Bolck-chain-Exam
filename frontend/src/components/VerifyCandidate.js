...
const VerifyCandidate = () => {
    ...
    const verify = async () => {
        ...
        try {
            ...
            const existing = JSON.parse(sessionStorage.getItem("verifiedCandidates")) || [];
            const newVerified = { address }; // Extend if needed with name/email
            sessionStorage.setItem("verifiedCandidates", JSON.stringify([...existing, newVerified]));
